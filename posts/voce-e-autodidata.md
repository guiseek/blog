...
William Glasser desenvolveu a **teoria da escolha** aplicando na área da educação.
...
A educação não deve se limitar a mecânica da memorização ou técnicas similares que contribuem pouco no aprendizado.
